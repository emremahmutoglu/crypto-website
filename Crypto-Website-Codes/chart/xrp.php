...
$coin_id = 7; // XRP coin_id, coins tablosunda XRP için olan ID
...
<head>
    ...
    <title>Yatırım Radarı XRP/USDT Grafik</title>
...
<body>
    ...
    <script>
        ...
        function toggleFavorite() {
            ...
            const coinName = 'XRP'; // Burada coin_name sabit olarak atanmıştır. Diğer coin sayfaları için bu değeri dinamik olarak güncelleyebilirsiniz.
