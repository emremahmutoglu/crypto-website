...
$coin_id = 4; // BNB coin_id, coins tablosunda Binance Coin için olan ID
...
<head>
    ...
    <title>Yatırım Radarı BNB/USDT Grafik</title>
...
<body>
    ...
    <script type="text/javascript" src="bnb.js"></script>
    ...
    <script>
        ...
        function toggleFavorite() {
            ...
            const coinName = 'BNB'; // Burada coin_name sabit olarak atanmıştır. Diğer coin sayfaları için bu değeri dinamik olarak güncelleyebilirsiniz.
