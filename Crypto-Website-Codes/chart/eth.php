...
$coin_id = 2; // ETH coin_id, coins tablosunda Ethereum için olan ID
...
<head>
    ...
    <title>Yatırım Radarı ETH/USDT Grafik</title>
...
<body>
    ...
    <script>
        ...
        function toggleFavorite() {
            ...
            const coinName = 'Ethereum'; // Burada coin_name sabit olarak atanmıştır. Diğer coin sayfaları için bu değeri dinamik olarak güncelleyebilirsiniz.
