...
$coin_id = 5; // SOL coin_id, coins tablosunda Solana için olan ID
...
<head>
    ...
    <title>Yatırım Radarı SOL/USDT Grafik</title>
...
<body>
    ...
    <script>
        ...
        function toggleFavorite() {
            ...
            const coinName = 'Solana'; // Burada coin_name sabit olarak atanmıştır. Diğer coin sayfaları için bu değeri dinamik olarak güncelleyebilirsiniz.
