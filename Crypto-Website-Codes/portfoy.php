...
// Coin silmek için kontrol et
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == 'delete') {
    $id = $_POST['id'];

    $sql = "DELETE FROM portfoy WHERE id = ? AND user_id = ?";
    $stmt = $pdo->prepare($sql);
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="POST" action="portfoy.php" style="display:inline;">
                                    <input type="hidden" name="action" value="delete">
                                    <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']); ?>">
                                    <span class="delete-button" onclick="this.closest('form').submit();"><i class='bx bx-x'></i></span>
                                </form>
                            </td>
                        </tr>
                        <?php endforeach; ?>
